...
namespace GraphicalDynamo.Core.Octree
{
    ...
    public class Octree
    {
        ...
        public Octree(MeshToolkit mesh, bool cubic = true)
        {
            ...
            this.vertexIndexByTri = _mesh.VertexIndicesByTri().Chop<int>(3);
            BoundingBox bbox = Geometry.Meshes.BoundingBox(this._mesh);
            ...
            if (cubic)
            {
                using (Point center = Geometry.Points.MidPoint(bbox.MinPoint, bbox.MaxPoint))
                {
